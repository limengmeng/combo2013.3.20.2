...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==0) {
        cell.backgroundView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"UPview@2x.png"]];
    ...
    if (indexPath.section==1) {
        if (indexPath.row==3) {
            cell.backgroundView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"UPview3@2x.png"]];
        }
        else
        {
            cell.backgroundView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"UPview2@2x.png"]];
        }
    ...
    if (indexPath.section==2) {
        cell.backgroundView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"Uinfoview@2x.png"]];
