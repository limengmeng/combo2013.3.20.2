...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (section==0) {
        ...
        cell.backgroundView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"ALviewNOshade@2x.png"]];
    ...
    if (section==2) {
        ...
        if (indexPath.row==0) {
            cell.backgroundView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"AOmessage2one@2x.png"]];
        ...
        if (indexPath.row==1) {
            cell.backgroundView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"AOmessage2two@2x.png"]];
...
{
    if (section==0) {
        UIImageView* shadowview=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"AoViewShadow@2x.png"]];
