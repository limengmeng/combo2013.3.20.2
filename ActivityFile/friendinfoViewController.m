...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section!=2) {
        ...
        cell.backgroundView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"Fbackview@2x.png"]];
    ...
    else
    {
        ...
        if (indexPath.row==0) {
            cell.backgroundView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"FInformation1@2x.png"]];
        ...
        {
            cell.backgroundView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"Fbackview2@2x.png"]];
