...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (segment==0){
        ...
        cell.backgroundView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"huodongkuang@2x.png"]];
        ...
        title=[[UILabel alloc]initWithFrame:CGRectMake(150, 7, 144, 34)];
    ...
    else
    {
        ...
        cell.backgroundView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"Lview@2x.png"]];
        UIImageView* imageview;
        UILabel* addrlabel;
        UILabel* peoplenum;
        UILabel* partynum;
